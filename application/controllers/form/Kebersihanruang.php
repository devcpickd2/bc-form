...
class Kebersihanruang extends CI_Controller {
	...
	public function cetak()
	{
		...
		$kebersihanruang_data = $this->kebersihanruang_model->get_by_uuid_kebersihanruang($selected_items);

		$kebersihanruang_data_verif = $this->kebersihanruang_model->get_by_uuid_kebersihanruang_verif($selected_items);

		$data['kebersihanruang'] = $kebersihanruang_data_verif;


		if (!$data['kebersihanruang']) {
