...
class Kebersihanmesin extends CI_Controller {
	...
	public function cetak()
	{
		...
		$kebersihanmesin_data = $this->kebersihanmesin_model->get_by_uuid_kebersihanmesin($selected_items);

		$kebersihanmesin_data_verif = $this->kebersihanmesin_model->get_by_uuid_kebersihanmesin_verif($selected_items);

		$data['kebersihanmesin'] = $kebersihanmesin_data_verif;


		if (!$data['kebersihanmesin']) {
		...
		$data['kebersihanmesin']->nama_lengkap_produksi = $this->pegawai_model->get_nama_lengkap($data['kebersihanmesin']->nama_produksi);
