<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Update Verifikasi Residu Klorin</h1>
                ...
                <form class="user" method="post" action="<?= base_url('residu/edit/'.$residu->uuid);?>">
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <input type="date" name="date" class="form-control <?= form_error('date') ? 'invalid' : '' ?> " value="<?= $residu->date; ?>">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="area" class="form-control <?= form_error('area') ? 'invalid' : '' ?> " value="<?= $residu->area; ?>">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="titik_sampling" class="form-control <?= form_error('titik_sampling') ? 'invalid' : '' ?> " value="<?= $residu->titik_sampling; ?>">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="standar" class="form-control <?= form_error('standar') ? 'invalid' : '' ?> " value="<?= $residu->standar; ?>">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="hasil_pemeriksaan" class="form-control <?= form_error('hasil_pemeriksaan') ? 'invalid' : '' ?> " value="<?= $residu->hasil_pemeriksaan; ?>">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-check">
                                ...
                                value="Tidak Ok" 
                                <?= ($residu->keterangan === 'Tidak Ok') ? 'checked' : '' ?>>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="tindakan" class="form-control <?= form_error('tindakan') ? 'invalid' : '' ?> " value="<?= $residu->tindakan; ?>">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="verifikasi" class="form-control <?= form_error('verifikasi') ? 'invalid' : '' ?> " value="<?= $residu->verifikasi; ?>">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-6">
                            ...
                            <textarea class="form-control" name="catatan"><?= $residu->catatan; ?></textarea>
