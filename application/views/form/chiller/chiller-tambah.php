<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Tambah Pemeriksaan Suhu Chiller</h1>
    <nav aria-label="breadcrumb">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form class="user" method="post" action="<?= base_url('chiller/tambah');?>">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-3">
                            ...
                            <input type="text" name="chiller_1" class="form-control <?= form_error('chiller_1') ? 'invalid' : '' ?> " value="<?= set_value('chiller_1'); ?>">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" name="chiller_2" class="form-control <?= form_error('chiller_2') ? 'invalid' : '' ?> " value="<?= set_value('chiller_2'); ?>">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" name="chiller_3" class="form-control <?= form_error('chiller_3') ? 'invalid' : '' ?> " value="<?= set_value('chiller_3'); ?>">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" name="chiller_4" class="form-control <?= form_error('chiller_4') ? 'invalid' : '' ?> " value="<?= set_value('chiller_4'); ?>">
