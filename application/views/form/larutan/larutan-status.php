<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form class="user" method="post" action="<?= base_url('larutan/status/'.$larutan->uuid);?>">
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label class="form-label font-weight-bold">Status</label>
                                <select class="form-control <?= form_error('status_spv') ? 'invalid' : '' ?>" name="status_spv">
                                    <option value="1" <?= set_select('status_spv', '1'); ?> <?= $larutan->status_spv == 1?'selected':'';?>>Verified</option>
                                    <option value="2" <?= set_select('status_spv', '2'); ?> <?= $larutan->status_spv == 2?'selected':'';?>>Revision</option>
                                </select>
                        ...
                        <div class="row form-group">
                            <div class="col-sm-6">
                                ...
                                <textarea class="form-control" name="catatan_spv" ><?= $larutan->catatan_spv; ?></textarea>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="<?= base_url('larutan/verifikasi')?>" class="btn btn-md btn-danger">
