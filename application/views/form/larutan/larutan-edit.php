                                ...
                                <tr>
                                    ...
                                    <td>
                                      <select name="kebutuhan[]" class="form-control form-control-sm">
                                        ...
                                        <option value="Cleaning Lantai" <?= ($row['kebutuhan'] == 'Cleaning Lantai') ? 'selected' : '' ?>>Cleaning Lantai</option>
                                        <option value="Cleaning mesin dan alat" <?= ($row['kebutuhan'] == 'Cleaning mesin dan alat') ? 'selected' : '' ?>>Cleaning mesin dan alat</option>
                                        <option value="Cuci tangan" <?= ($row['kebutuhan'] == 'Cuci tangan') ? 'selected' : '' ?>>Cuci tangan</option>
                                        <option value="Sanitasi Mesin dan alat" <?= ($row['kebutuhan'] == 'Sanitasi Mesin dan alat') ? 'selected' : '' ?>>Sanitasi Mesin dan alat</option>
                                        <option value="Foot Basin" <?= ($row['kebutuhan'] == 'Foot Basin') ? 'selected' : '' ?>>Foot Basin</option>
                                        <option value="Hand Basin" <?= ($row['kebutuhan'] == 'Hand Basin') ? 'selected' : '' ?>>Hand Basin</option>
                                    </select>
                                </td>
