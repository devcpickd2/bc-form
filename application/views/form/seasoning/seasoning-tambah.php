                ...
                <form class="user" method="post" action="<?= base_url('seasoning/tambah');?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('kotoran') ? 'is-invalid' : '' ?>" type="radio" name="kotoran" value="sesuai" <?= set_value('kotoran') == 'sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Sesuai</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('kotoran') ? 'is-invalid' : '' ?>" type="radio" name="kotoran" value="tidak sesuai" <?= set_value('kotoran') == 'tidak sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Tidak Sesuai</label>
                            </div>
                            <div class="invalid-feedback d-block">
                                <?= form_error('kotoran') ?>
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('aroma') ? 'is-invalid' : '' ?>" type="radio" name="aroma" value="sesuai" <?= set_value('aroma') == 'sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Sesuai</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('aroma') ? 'is-invalid' : '' ?>" type="radio" name="aroma" value="tidak sesuai" <?= set_value('aroma') == 'tidak sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Tidak Sesuai</label>
                            </div>
                            <div class="invalid-feedback d-block">
                                <?= form_error('aroma') ?>
