                        ...
                        <form class="user" method="post" action="<?= base_url('magnettrap/status/'.$magnettrap->uuid);?>">
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control <?= form_error('status_spv') ? 'invalid' : '' ?>" name="status_spv">
                                        <option value="1" <?= set_select('status_spv', '1'); ?> <?= $magnettrap->status_spv == 1?'selected':'';?>>Verified</option>
                                        <option value="2" <?= set_select('status_spv', '2'); ?> <?= $magnettrap->status_spv == 2?'selected':'';?>>Revision</option>
                                    </select>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <a href="<?= base_url('magnettrap/verifikasi')?>" class="btn btn-md btn-danger">
