                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><b>Shift : <?= $magnettrap->shift;?><b></td>
                                        ...
                                        <tr>
                                            <td>Diketahui Enginer</td>
                                            <td colspan="4">
                                                <?php
                                                if ($magnettrap->status_enginer == 0) {
                                                    echo '<span style="color: #99a3a4; font-weight: bold;">Created</span>';
                                                } elseif ($magnettrap->status_enginer == 1) {
                                                    echo '<span style="color: #28b463; font-weight: bold;">Checked</span>';
                                                } elseif ($magnettrap->status_enginer == 2) {
                                                    echo '<span style="color: red; font-weight: bold;">Re-Check</span>';
                                                }
                                            ?></td>
                                        </tr>
                                        <tr>
                                            <td>Catatan Enginer</td>
                                            <td colspan="4"><?= !empty($magnettrap->catatan_enginer) ? $magnettrap->catatan_enginer : 'Tidak ada'; ?></td>
                                        </tr>
                                        <tr>
                                            <td>Disetujui Supervisor</td>
                                            <td colspan="4"><?php
                                            if ($magnettrap->status_spv == 0) {
                                                echo '<span style="color: #99a3a4; font-weight: bold;">Created</span>';
                                            } elseif ($magnettrap->status_spv == 1) {
                                                echo '<span style="color: #28b463; font-weight: bold;">Verified</span>';
                                            } elseif ($magnettrap->status_spv == 2) {
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4"><?= !empty($magnettrap->catatan_spv) ? $magnettrap->catatan_spv : 'Tidak ada'; ?></td>
                                    </tr>
                                </tbody>
                            </table>    
                        </div>
