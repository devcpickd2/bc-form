                ...
                <form class="user" method="post" action="<?= base_url('thermometer/edit/'.$thermometer->uuid);?>">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="peneraan_waktu" class="form-control <?= form_error('peneraan_waktu') ? 'invalid' : '' ?> " value="<?= $thermometer->peneraan_waktu; ?>">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="peneraan_hasil" class="form-control <?= form_error('peneraan_hasil') ? 'invalid' : '' ?> " value="<?= $thermometer->peneraan_hasil; ?>">
