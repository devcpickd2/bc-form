<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb"> 
            <li class="breadcrumb-item">
                <a href="<?= isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] . '?search=' . urlencode($this->input->get('search')) : base_url('verifikasimagnet-verifikasi'); ?>">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form class="user" method="post" action="<?= base_url('verifikasimagnet/status/'.$verifikasimagnet->uuid);?>">
                <div class="form-group row">
                    <div class="col-sm-6">
                ...
                <div class="row form-group">
                    <div class="col-sm-6">
                        ...
                        <textarea class="form-control" name="catatan_spv" ><?= $verifikasimagnet->catatan_spv; ?></textarea>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <a href="<?= base_url('verifikasimagnet/verifikasi')?>" class="btn btn-md btn-danger">
