<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Update Verifikasi Proses Produksi</h1>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="shift" class="form-control">
                            ...
                            <option value="1" <?= set_select('shift', '1', $proses->shift == '1') ?>>Shift 1</option>
                            <option value="2" <?= set_select('shift', '2', $proses->shift == '2') ?>>Shift 2</option>
                            <option value="3" <?= set_select('shift', '3', $proses->shift == '3') ?>>Shift 3</option>
                        </select>
                    </div>
                    <div class="col-sm-3">
                        ...
                        <select name="nama_produk" id="select_nama_produk" class="form-control">
                            ...
                            <?php foreach ($produk_list as $produk): ?>
                                <option value="<?= $produk->nama_produk ?>" <?= set_select('nama_produk', $produk->nama_produk, $proses->nama_produk == $produk->nama_produk) ?>>
                                    <?= $produk->nama_produk ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
