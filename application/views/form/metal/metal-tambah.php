    ...
    <div class="card-body">
      ...
      <form method="post" action="<?= base_url('metal/tambah'); ?>">
        ...
        <table class="table table-bordered table-striped align-middle">
          <tbody>
            ...
            <tr>
              ...
              <td>
                <select name="deteksi_ng" class="form-control <?= form_error('deteksi_ng') ? 'is-invalid' : '' ?>">
                  <option value="-" <?= set_select('deteksi_ng','-',true) ?>>Tidak Ada</option>
                  <option value="1" <?= set_select('deteksi_ng','1') ?>>Belt Conveyor Berhenti</option>
                  <option value="2" <?= set_select('deteksi_ng','2') ?>>Rejector</option>
                </select>
            ...
            <tr>
              ...
              <td colspan="3">
                <textarea name="catatan_metal" class="form-control"><?= set_value('catatan_metal') ?></textarea>
              </td>
            </tr>
        ...
        <div class="mt-3">
          ...
          <a href="<?= base_url('metal') ?>" class="btn btn-danger">
