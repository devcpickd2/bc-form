    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb"> 
            <li class="breadcrumb-item">
                <a href="<?= isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] . '?search=' . urlencode($this->input->get('search')) : base_url('produksi-verifikasi'); ?>">
                    ...
                    <div class="form-group row">
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>QC</td>
                                    <td colspan="5"> <?= !empty($produksi->username) ? $produksi->username : 'Tidak ada'; ?></td>
                                </tr>
                                <tr>
