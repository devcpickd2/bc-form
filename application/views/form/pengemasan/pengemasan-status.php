    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb"> 
            <li class="breadcrumb-item">
                <a href="<?= isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] . '?search=' . urlencode($this->input->get('search')) : base_url('pengemasan-verifikasi'); ?>">
                ...
                <div class="form-group row">
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tr>
                                <td>Kadar Air</td>
                                <td colspan="6"><?= $pengemasan->kadar_air;?></td>
                            </tr>
                            <tr>
            ...
            <form class="user" method="post" action="<?= base_url('pengemasan/status/'.$pengemasan->uuid);?>">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <a href="<?= base_url('pengemasan/verifikasi')?>" class="btn btn-md btn-danger">
