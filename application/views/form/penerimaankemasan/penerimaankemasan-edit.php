<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Update Pemeriksaan Penerimaan Kemasan dari Supplier</h1>
                ...
                <form class="user" method="post" action="<?= base_url('penerimaankemasan/edit/'.$penerimaankemasan->uuid);?>" enctype="multipart/form-data">
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <input type="date" name="date" class="form-control <?= form_error('date') ? 'invalid' : '' ?> " value="<?= $penerimaankemasan->date; ?>">
                        ...
                        <div class="col-sm-6">
                            ...
                            <select class="form-control <?= form_error('shift') ? 'invalid' : '' ?>" name="shift">
                                <option value="1" <?= set_select('shift', '1'); ?> <?= $penerimaankemasan->shift == 1?'selected':'';?>>1</option>
                                <option value="2" <?= set_select('shift', '2'); ?> <?= $penerimaankemasan->shift == 2?'selected':'';?>>2</option>
                                <option value="3" <?= set_select('shift', '3'); ?> <?= $penerimaankemasan->shift == 3?'selected':'';?>>3</option>
                            </select>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="jenis_kemasan" class="form-control <?= form_error('jenis_kemasan') ? 'invalid' : '' ?> " value="<?= $penerimaankemasan->jenis_kemasan; ?>">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="pemasok" class="form-control <?= form_error('pemasok') ? 'invalid' : '' ?> " value="<?= $penerimaankemasan->pemasok; ?>">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('warna') ? 'is-invalid' : '' ?>" 
                                type="radio" 
                                name="warna" 
                                value="sesuai" 
                                <?= ($penerimaankemasan->warna ?? '') == 'sesuai' ? 'checked' : '' ?>>
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                name="warna" 
                                value="tidak sesuai" 
                                <?= ($penerimaankemasan->warna ?? '') == 'tidak sesuai' ? 'checked' : '' ?>>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('panjang') ? 'is-invalid' : '' ?>" 
                                type="radio" 
                                name="panjang" 
                                value="sesuai" 
                                <?= ($penerimaankemasan->panjang ?? '') == 'sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Sesuai</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('panjang') ? 'is-invalid' : '' ?>" 
                                ...
                                name="panjang" 
                                value="tidak sesuai" 
                                <?= ($penerimaankemasan->panjang ?? '') == 'tidak sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Tidak Sesuai</label>
                            </div>
                            <div class="invalid-feedback d-block">
                                <?= form_error('panjang') ?>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('diameter') ? 'is-invalid' : '' ?>" 
                                type="radio" 
                                name="diameter" 
                                value="sesuai" 
                                <?= ($penerimaankemasan->diameter ?? '') == 'sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Sesuai</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('diameter') ? 'is-invalid' : '' ?>" 
                                ...
                                name="diameter" 
                                value="tidak sesuai" 
                                <?= ($penerimaankemasan->diameter ?? '') == 'tidak sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Tidak Sesuai</label>
                            </div>
                            <div class="invalid-feedback d-block">
                                <?= form_error('diameter') ?>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('lebar') ? 'is-invalid' : '' ?>" type="radio" name="lebar" value="sesuai" <?= ($penerimaankemasan->lebar ?? '') == 'sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Sesuai</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('lebar') ? 'is-invalid' : '' ?>" type="radio" name="lebar" value="tidak sesuai" <?= ($penerimaankemasan->lebar ?? '') == 'tidak sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Tidak Sesuai</label>
                            </div>
                            <div class="invalid-feedback d-block">
                                <?= form_error('lebar') ?>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('tinggi') ? 'is-invalid' : '' ?>" type="radio" name="tinggi" value="sesuai" <?= ($penerimaankemasan->tinggi ?? '') == 'sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Sesuai</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('tinggi') ? 'is-invalid' : '' ?>" type="radio" name="tinggi" value="tidak sesuai" <?= ($penerimaankemasan->tinggi ?? '') == 'tidak sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Tidak Sesuai</label>
                            </div>
                            <div class="invalid-feedback d-block">
                                <?= form_error('tinggi') ?>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('berat') ? 'is-invalid' : '' ?>" type="radio" name="berat" value="sesuai" <?= ($penerimaankemasan->berat ?? '') == 'sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Sesuai</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('berat') ? 'is-invalid' : '' ?>" type="radio" name="berat" value="tidak sesuai" <?= ($penerimaankemasan->berat ?? '') == 'tidak sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Tidak Sesuai</label>
                            </div>
                            <div class="invalid-feedback d-block">
                                <?= form_error('berat') ?>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('delaminasi') ? 'is-invalid' : '' ?>" type="radio" name="delaminasi" value="sesuai" <?= $penerimaankemasan->delaminasi == 'sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Sesuai</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('delaminasi') ? 'is-invalid' : '' ?>" type="radio" name="delaminasi" value="tidak sesuai" <?= $penerimaankemasan->delaminasi == 'tidak sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Tidak Sesuai</label>
                            </div>
                            <div class="invalid-feedback d-block">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('bau') ? 'is-invalid' : '' ?>" type="radio" name="bau" value="sesuai" <?= $penerimaankemasan->bau == 'sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Sesuai</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('bau') ? 'is-invalid' : '' ?>" type="radio" name="bau" value="tidak sesuai" <?= $penerimaankemasan->bau == 'tidak sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Tidak Sesuai</label>
                            </div>
                            <div class="invalid-feedback d-block">
                                <?= form_error('bau') ?>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('desain') ? 'is-invalid' : '' ?>" type="radio" name="desain" value="sesuai" <?= $penerimaankemasan->desain == 'sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Sesuai</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= form_error('desain') ? 'is-invalid' : '' ?>" type="radio" name="desain" value="tidak sesuai" <?= $penerimaankemasan->desain == 'tidak sesuai' ? 'checked' : '' ?>>
                                <label class="form-check-label">Tidak Sesuai</label>
                            </div>
                            <div class="invalid-feedback d-block">
                                <?= form_error('desain') ?>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-3">
                            ...
                            <input type="text" name="segel" class="form-control <?= form_error('segel') ? 'invalid' : '' ?> " value="<?= $penerimaankemasan->segel; ?>">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                name="penerimaan" 
                                value="ok" 
                                <?= ($penerimaankemasan->penerimaan ?? '') == 'ok' ? 'checked' : '' ?>>
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                name="penerimaan" 
                                value="tolak" 
                                <?= ($penerimaankemasan->penerimaan ?? '') == 'tolak' ? 'checked' : '' ?>>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-3">
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                name="coa" 
                                value="ada" 
                                <?= ($penerimaankemasan->coa ?? '') == 'ada' ? 'checked' : '' ?>>
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                name="coa" 
                                value="tidak ada" 
                                <?= ($penerimaankemasan->coa ?? '') == 'tidak ada' ? 'checked' : '' ?>>
                        ...
                        <div class="col-sm-3">
                            ...
                            <?php if (!empty($penerimaankemasan->bukti_coa)): ?>
                                <a href="<?= base_url('uploads/' . $penerimaankemasan->bukti_coa); ?>" target="_blank">Lihat Gambar Sebelumnya</a>
                                <br>
                            <?php endif; ?>
                            <br>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <textarea class="form-control" name="keterangan"><?= $penerimaankemasan->keterangan; ?></textarea>
