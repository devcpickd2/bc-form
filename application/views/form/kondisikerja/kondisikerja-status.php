        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form class="user" method="post" action="<?= base_url('kondisikerja/status/'.$kondisikerja->uuid);?>">
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                ...
                                <div class="row form-group">
                                    <div class="col-sm-6">
                                        ...
                                        <textarea class="form-control" name="catatan_spv" ><?= $kondisikerja->catatan_spv; ?></textarea>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <a href="<?= base_url('kondisikerja/verifikasi')?>" class="btn btn-md btn-danger">
