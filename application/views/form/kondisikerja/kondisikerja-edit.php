            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <textarea class="form-control" name="verifikasi_higiene"><?= $kondisikerja->verifikasi_higiene; ?></textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <label class="form-label font-weight-bold">Verifikasi</label>
                        <textarea class="form-control" name="verifikasi_kebersihan"><?= $kondisikerja->verifikasi_kebersihan; ?></textarea>
                ...
                <div class="form-group row">
                    <div class="col-sm-5">
                        ...
                        <select name="kondisi_peralatan" class="form-control <?= form_error('kondisi_peralatan') ? 'is-invalid' : '' ?>">
                            ...
                            $selected_value = set_value('kondisi_peralatan', isset($kondisikerja->kondisi_peralatan) ? $kondisikerja->kondisi_peralatan : '');
                            foreach ($options as $value => $label): 
                                ?>
                                <option value="<?= $value ?>" <?= $selected_value == $value ? 'selected' : '' ?>><?= $label ?></option>
                            <?php endforeach; ?>
                ...
                <div class="form-group row">
                    <div class="col-sm-4">
                        <label class="form-label font-weight-bold">Problem</label>
                        <textarea class="form-control" name="problem_peralatan"><?= $kondisikerja->problem_peralatan; ?></textarea>
                    ...
                    <div class="col-sm-4">
                        <label class="form-label font-weight-bold">Tindakan Koreksi</label>
                        <textarea class="form-control" name="tindakan_peralatan"><?= $kondisikerja->tindakan_peralatan; ?></textarea>
                    ...
                    <div class="col-sm-4">
                        <label class="form-label font-weight-bold">Verifikasi</label>
                        <textarea class="form-control" name="verifikasi_peralatan"><?= $kondisikerja->verifikasi_peralatan; ?></textarea>
