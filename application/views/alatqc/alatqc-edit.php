<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Update Inventaris Alat QC</h1>
    <nav aria-label="breadcrumb">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form class="user" method="post" action="<?= base_url('alatqc/edit/'.$alatqc->uuid);?>">
                    <div class="form-group row">
                        <div class="col-sm-4">
                            <label class="form-label font-weight-bold">Nama Alat</label>
                            <input type="text" name="nama_alat" class="form-control <?= form_error('nama_alat') ? 'invalid' : '' ?> " value="<?= $alatqc->nama_alat; ?>">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="number" name="jumlah" class="form-control <?= form_error('jumlah') ? 'invalid' : '' ?> " value="<?= $alatqc->jumlah; ?>">
