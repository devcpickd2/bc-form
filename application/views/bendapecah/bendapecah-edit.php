<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Update Benda Pecah Belah</h1>
    <nav aria-label="breadcrumb">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form class="user" method="post" action="<?= base_url('bendapecah/edit/'.$bendapecah->uuid);?>">
                    <div class="form-group row">
                        <div class="col-sm-4">
                            <label class="form-label font-weight-bold">Nama Benda</label>
                            <input type="text" name="nama_benda" class="form-control <?= form_error('nama_benda') ? 'invalid' : '' ?> " value="<?= $bendapecah->nama_benda; ?>">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="number" name="jumlah" class="form-control <?= form_error('jumlah') ? 'invalid' : '' ?> " value="<?= $bendapecah->jumlah; ?>">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4">
                            ...
                            <input type="text" name="pemilik" class="form-control <?= form_error('pemilik') ? 'invalid' : '' ?> " value="<?= $bendapecah->pemilik; ?>">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" name="area" class="form-control <?= form_error('area') ? 'invalid' : '' ?> " value="<?= $bendapecah->area; ?>">
